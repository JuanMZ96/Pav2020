namespace Pav2.Reports
{
    partial class ReportUsuarioCursoAvance
    {
        ...
        private void InitializeComponent()
        {
            ...
            // reportViewer1
            // 
            reportDataSource1.Name = "UsuarioCursoAvance";
            reportDataSource1.Value = this.UsuariosCursoAvanceBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Pav2.Reports.Report1.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(136, 138);
            ...
            // 
            this.UsuariosCursoAvanceBindingSource.DataSource = typeof(ClassLibrary1.UsuariosCursoAvance);
            // 
